...
``` r
auto_replace(frm, replacement_func, include_pos = FALSE, filter = FALSE)
```
...
- include_pos:
  ...
  Logical. If `TRUE` will replacement prefix will be the POS tag.
...
#>  2 "[Scene: Central Perk, everyone is there.]"                       Perk  MWLE…
#>  3 "Oh, Ross, Mon, is it okay if I bring someone to your parent's a… Ross  MWLE…
#>  4 "Oh, Ross, Mon, is it okay if I bring someone to your parent's a… Mon   MWLE…
#>  5 "Well, his name is Parker and I met him at the drycleaners."      Park… MWLE…
#>  6 "Every year Ross makes the toast, and it's always really moving,… Ross  MWLE…
#>  7 "And you wonder why Ross is their favorite?"                      Ross  MWLE…
#>  8 "Any time Ross makes a toast everyone cries, and hugs him, and p… Ross  MWLE…
#>  9 "[Scene: Chandler and Monica's, they're getting ready to leave f… Chan… MWLE…
#> 10 "[Scene: Chandler and Monica's, they're getting ready to leave f… Moni… MWLE…
```
